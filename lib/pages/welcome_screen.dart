                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/firstOnBoard.jpg',
                                ),
                                // height: 300.0,
                                // width: 300.0,
                              ),
                            ...
                            Text(
                              'If we have a deep look at it\nIt actually is not a Waste it is a Gain!',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 20.0,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/secondOnBoard.jpg',
                                ),
                                height: 300.0,
                                width: 300.0,
                              ),
                            ...
                            SizedBox(height: 30.0),
                            Text(
                              'The abundant resource,\nthat we have Never benefited from!',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 20.0,
                                fontWeight: FontWeight.bold,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Center(
                              child: Image(
                                image: AssetImage(
                                  'assets/images/thirdOnBoard.jpg',
                                ),
                                height: 300.0,
                                width: 300.0,
                              ),
