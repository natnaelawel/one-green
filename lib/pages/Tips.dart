        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: ListTile(title: Text('Put everything away after use.', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)
                ,subtitle: Padding(
                  padding: const EdgeInsets.fromLTRB(0,0,0,10),
                  child: Text('This might seem like an obvious tip, but failing to'
                      ...
                      'to make sure that anything you wear, use or move ends up where it belongs. It’s easy to leave a pair of s',style: TextStyle(fontSize: 18),),
                )
                ,),
            )
          ],
